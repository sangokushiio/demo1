(function () {
    ...
    function onload() {
        ...
        var bundleRoot = [INTERNAL, "map1", "map2", "map3", "bundle"];
        ...
        for (let i = 0; i < bundleRoot.length; i++) {
            if (bundleRoot[i] == 'internal') {
                cc.assetManager.loadBundle('assets/' + bundleRoot[i], cb);
            } else {
                cc.assetManager.loadBundle('https://cdn.jsdelivr.net/gh/sangoshikuio/' + bundleRoot[i], cb);
            }
        }
    }
})();