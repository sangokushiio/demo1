    ...
    return (() => {
        ...
        var N, U = function () {
            ...
            G = function (e) {
                ...
                return P(t, e), t.prototype.install = function () {
        ...
        function Je() {
            ...
            P(t, e), Object.defineProperty(t.prototype, "name", {
                get: function () {
                    return "isInClient"
                },
                enumerable: !1,
        ...
        var yt = function () {
            ...
            St = new(function (e) {
                ...
                return P(t, e), Object.defineProperty(t.prototype, "name", {
                    get: function () {
                        return "isSubWindow"
                    },
                    enumerable: !1,
        ...
        function jt(e) {
            if (! function (e) {
                ...
                }(e)) throw Ce(z, "Unexpected API name.");
            var t = Lt[e];
        ...
        var fn = function (e) {
            ...
            this.identification = {
                ...
                return k(t, F([], x(e), !1), void 0, (function (e) {
                    return void 0 === e && (e = "appData"), A(this, (function (t) {
                        switch (t.label) {
                            case 0:
                                return [4, this.send({
                ...
                return k(t, void 0, void 0, (function () {
                    var t, n = this;
                    return A(this, (function (r) {
                        return t = e.data.messageBusEvent, "https://liff-subwindow.line.me" !== e.origin ? [2] : t ? (this.sentMessages.includes(cn(t)) || t.identifier !== this.identification.identifier || t.action !== en && !t.replyTarget || this.listeners.forEach((function (e) {
                            return k(n, void 0, void 0, (function () {
                                var n, r, i;
                                return A(this, (function (o) {
                                    switch (o.label) {
                                        case 0:
                                            return n = e, r = [_({}, t)], i = {}, [4, this.getDecryptedContext(t.context)];
                                        case 1:
                                            return n.apply(void 0, [_.apply(void 0, r.concat([(i.context = o.sent(), i)]))]), [2]
                                    }
                                }))
                            }))
                        })), [2]) : [2]
        ...
        function mn(e, t, n) {
            ...
            if (!window._liff || !window._liff.postMessage) throw Ce(z, "postMessage is not available from client");
        ...
        function Rn() {
            return k(this, arguments, void 0, (function (e) {
                return void 0 === e && (e = nn), A(this, (function (t) {
                    switch (t.label) {
                        case 0:
        ...
        function Hn(e) {
            return k(this, arguments, void 0, (function (e, t) {
                var n, r, i, o, a, s, c, u;
                return void 0 === t && (t = {}), A(this, (function (l) {
                    switch (l.label) {
                        case 0:
                        ...
                        case 4:
                            return u = a ? o : location.origin, [2, new Promise((function (t) {
                                window.addEventListener("message", (function n(i) {
                                    Vn(i) && (window.removeEventListener("message", n), t({
                                        status: e,
                                        result: r
                                    }))
        ...
        function Gn(e) {
            ...
            if (e.origin === n) {
                ...
                if (r) {
                    ...
                    switch (o) {
                        case fe:
                            window.clearInterval(Nn()), zn();
                            break;
                        case ue.CANCEL:
                        case ue.SUBMIT:
                            xn(!0), window.clearInterval(Nn()), window.removeEventListener("message", Gn), In(o, i), null === (t = jn()) || void 0 === t || t.postMessage({
                                type: o
                            }, Un());
                            break;
                        default:
        ...
        function Jn() {
            window.clearInterval(Cn), window.clearInterval(Nn()), window.removeEventListener("message", Gn)
        }

        function qn(e) {
            if (void 0 === e && (e = !1), Jn(), xn(!1), e) {
                var t = jn();
                t && (t.close(), Fn(null))
            }
        }
                ...
                return A(this, (function (m) {
                    switch (m.label) {
                        case 0:
                            ...
                            m.label = 1;
                        case 1:
                            return m.trys.push([1, 3, , 5]), [4, Jt($t("subWindowSubscribe"), {
                                method: "POST",
                                body: JSON.stringify({
                                    msit: t,
                                    mstChallenge: n
                        ...
                        case 8:
                            return d = m.sent(), f = d ? Ce(z, d.errorDetail) : Ce(J, "Some error happened in the server"), s(f), [3, 17];
                        case 9:
                            return 200 !== l.status ? [3, 16] : [4, Qn(l)];
                        case 10:
                            if (!(d = m.sent())) return s(Ce(J, "Some error happened in the server")), [2];
                        ...
                        case 13:
                            return a(h, p), [3, 15];
                        case 14:
                            s(Ce(J, "Some error happened in the server")), m.label = 15;
                        case 15:
                            return [3, 17];
                        case 16:
                            s(Ce(J, "Some error happened in the server")), m.label = 17;
                        case 17:
                            return [2]
                    }
                }))
        ...
        function er(e) {
            ...
            if (!o) return Promise.reject(Ce(z, "params.url must be liff url or mini url"));
                ...
                return function (e, t) {
                    return k(this, void 0, void 0, (function () {
                        ...
                        return A(this, (function (o) {
                            switch (o.label) {
                                case 0:
                                    return n = e.url, (r = new URLSearchParams).set("msit", t), [4, null === (i = e.onBeforeTransition) || void 0 === i ? void 0 : i.call(e)];
                                case 1:
                                    return o.sent(), location.href = "".concat("liff://subwindow", "?url=").concat(encodeURIComponent(n), "&").concat(r.toString()), [2]
                            }
                        }))
                    }))
                }(e, t)
        ...
        function tr(e) {
            return Ft.subwindowOpen(), Je() ? er(e) : function (e) {
                return k(this, void 0, void 0, (function () {
                    var t, n, r, i, o, a, s, c, u, l, f, d;
                    return A(this, (function (h) {
                        switch (h.label) {
                            case 0:
                                return (t = De(e.url)) ? (qn(!0), [4, zn()]) : [2, Promise.reject(Ce(z, "params.url must be liff url or mini url"))];
                            case 1:
                                return h.sent(), Fn("ios" !== Ot() || We() ? window.open("", "liffsubwindow", "width=480, height=640, menubar=no, toolbar=no, scrollbars=yes") : window.open()), n = e.url, r = e.appData, (i = new URL(n)).searchParams.append(le, "true"), [4, Rn()];
                            case 2:
                                return o = h.sent(), i.searchParams.append(Qt, o.identification.identifier), i.searchParams.append(Yt, o.identification.cryptoKey), i.hostname = function (e) {
                                    var t = x(e.split(".")),
                                        n = t[0],
                                        r = t.slice(1);
                                    return F(["".concat(n, "-ext")], x(r), !1).join(".")
                                }(i.hostname), a = i.toString(), [4, gn(t)];
                            case 3:
                                if (s = h.sent(), c = s.origin, u = s.subwindowCommonModule, !(l = jn())) throw Ce(Z);
                                if (!u) return l.close(), [2];
                                ! function (e) {
                                    Pn = e
                                }(c), o.listen(Kn), o.setData("appData", r), window.addEventListener("message", Gn), h.label = 4;
                            case 4:
                                return h.trys.push([4, 6, , 7]), [4, null === (d = e.onBeforeTransition) || void 0 === d ? void 0 : d.call(e)];
                            case 5:
                                return h.sent(), [3, 7];
                            case 6:
                                throw f = h.sent(), l.close(), f;
                            case 7:
                                return l.location.href = a, p = function (e, t) {
                                        var n = jn(),
                                            r = {
                                                type: fe
                                            };
                                    ...
                                    function (e) {
                                        ...
                                        var e = jn();
                                        e && e.closed && (Jn(), Fn(null), !1 === Ln() && (xn(!0), In(ue.CLOSE, {})))
                                    }), 100)), [2]
                        }
                        var p
                    }))
        ...
        function nr(e) {
            if (!e.mst || !e.status) return Promise.reject(Ce(z, "no proper argument"));
        ...
        function ir(e) {
            return void 0 === e && (e = {}), rr(), Je() ? function () {
                return k(this, arguments, void 0, (function (e) {
                    var t, n;
        ...
        var lr, fr = {
            ...
            mr = function (e) {
                var t, n = xe(43),
                    ...
                    }(hr()(n)).replace(/\+/g, "-").replace(/\//g, "_").replace(/=/g, ""),
                    i = qe();
            ...
            wr = function (e) {
                ...
                return P(t, e), Object.defineProperty(t.prototype, "name", {
                    ...
                    this.hooks.before.call(e), mr(e)
                }, t
            }(H),
            br = "undefined" == typeof navigator ? "en" : null !== (lr = navigator.language) && void 0 !== lr ? lr : "en",
            gr = null;
        ...
        function Sr(e) {
            if (null === gr) throw Ce($, "please call xlt after liff.init");
            return gr[e]
        }
        ...
        function Pr(e) {
            ...
            _r("--liff-base-background-color", f), _r("--liff-base-text-color", d), _r("--liff-base-background-rgb-color", be(f)), _r("--liff-base-text-rgb-color", be(d)), _r("--liff-light-button-border-color", h), _r("--liff-title-text-color", r), _r("--liff-title-background-color", a), _r("--liff-title-button-color", o), _r("--liff-icon-color", t), _r("--liff-status-bar-color", n), _r("--liff-title-subtext-color", i), _r("--liff-progress-bar-color", s), _r("--liff-progress-background-color", c), _r("--liff-title-button-area-background-color", me(u)), _r("--liff-title-button-area-border-color", me(l))
        }
                ...
                return A(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            return [4, Wt()];
                        case 1:
                            return (t = n.sent()) ? (t.install(e, kr), [2]) : [2]
                    }
                }))
            }))
        }
        ...
        function Fr(e, t) {
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (b) {
                    switch (b.label) {
                        case 0:
                            return n = e.split("."), r = x(n, 3), i = r[0], o = r[1], a = r[2], s = JSON.parse(pe.decode(i)), c = JSON.parse(pe.decodeUnicode(o)), u = ge(pe.decode(a)), l = ge("".concat(i, ".").concat(o)), [4, Lr()];
                        case 1:
                            ...
                            h = void 0, b.label = 2;
                        case 2:
                            return b.trys.push([2, 4, , 5]), [4, xr(d, l, u)];
                        case 3:
                            return h = b.sent(), [3, 5];
                        case 4:
                        ...
                        case 5:
                            if (h) {
                                if (v = c.iss !== "https://access.".concat("line.me"), m = c.aud !== t, w = 1e3 * c.exp < Date.now(), v) throw Ce(Y, 'Invalid "iss" value in ID_TOKEN');
        ...
        function Rr() {
            "boolean" == typeof Ur && R.warn("liff.init is not expected to be called more than once"), Ur = !!Boolean(ze(oe.IS_SUBSEQUENT_LIFF_APP)) || !(!Je() || ke(window.location.hash).feature_token || ot()) && (function (e) {
            ...
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (y) {
                    switch (y.label) {
                        ...
                        case 1:
                            return y.sent(), Rr(), [4, Wr(e.liffId)];
                        case 2:
                            if (t = y.sent(), n = t.access_token, r = t.context_token, i = t.feature_token, o = t.id_token, a = t.client_id, s = t.mst_verifier, c = t.mst_challenge, u = t.msit, r) {
                                if ("string" != typeof r) throw Ce($, "Cannot get context token, perhaps there is an incorrect parameter in permanent link");
                                Qe(jr(r))
                            }
                            if (void 0 !== (null === (b = Xe()) || void 0 === b ? void 0 : b.liffId) && (null === (g = Xe()) || void 0 === g ? void 0 : g.liffId) !== e.liffId) throw Ce($, "Invalid LIFF ID");
                            ...
                            }(e.liffId, i), Dr() && at(i)), c && function (e) {
                                $e(oe.MST_CHALLENGE, e)
                            }(c), s && function (e) {
                                $e(oe.MST_VERIFIER, e)
                            }(s), a && it(a), u && function (e) {
                                $e(oe.MSIT, e)
                            }(u), window.addEventListener("pageshow", Hr), bt() || i && n ? [3, 5] : Dr() ? (l = Ne(location.href, {
                                "liff.hback": "2"
                            }), mr({
                                redirectUri: l
                        ...
                        case 3:
                            y.sent(), y.label = 4;
                        case 4:
                            throw mr(), Ce($, "Failed to parse feature_token or access_token");
                        case 5:
                            return n && i ? [4, Xt(n)] : [3, 7];
                        case 6:
                            if (f = y.sent(), d = f.client_id, h = f.expires_in, p = Oe(e.liffId), d !== p) throw mr(), Ce($, "Failed to verify access_token");
                            at(i), pt(new Date(Date.now() + 1e3 * h)), lt(n), y.label = 7;
                        case 7:
                            return [4, Br(u, s)];
                        case 8:
                        ...
                        case 10:
                            return o && !st() && ct(o), o && a && !vt() ? [4, Fr(o, a)] : [3, 12];
                        case 11:
                            (w = y.sent()) && mt(w), y.label = 12;
                        case 12:
                            return [2]
                    }
                }))
        ...
        function Gr(e) {
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (c) {
                    switch (c.label) {
                        case 0:
                            return t = $t("apps"), n = "".concat(t, "/").concat(e, "/contextToken"), r = ut(), i = {
                                "Content-Type": "application/json",
                                Accept: "application/json"
                        ...
                        case 1:
                            if (o = c.sent(), !(a = o.contextToken)) throw Ce($, "Can not get context from server.");
                            if (!(s = jr(a))) throw Ce($, "Invalid context token.");
                            return [2, s]
                    }
                }))
            }))
                                ...
                                return k(i, void 0, void 0, (function () {
                                    ...
                                    return A(this, (function (s) {
                                        switch (s.label) {
                                            ...
                                            case 1:
                                                return t = s.sent(), n = t.access_token, r = t.id_token, i = t.expires_in, it(e), lt(n), pt(new Date(Date.now() + 1e3 * i)), ht(), r ? (ct(r), [4, Fr(r, e)]) : [3, 3];
                                            case 2:
                                                (o = s.sent()) && mt(o), s.label = 3;
                                            case 3:
        ...
        var zr = new(function () {
            function e() {
                ...
                this.getAndValidateContext = function () {
                    ...
                    if (!e.endpointUrl) throw Ce($, "Could not get endpointUrl from server.");
                    if (!e.permanentLinkPattern) throw Ce($, "Could not get permanentLinkPattern from server.");
                    return e
                ...
                return A(this, (function (r) {
                    switch (r.label) {
                        case 0:
                            ...
                            }() || Ht()), n = ke(window.location.search), !Tt() || Je() ? [3, 2] : [4, qr()];
                        case 1:
                            r.sent(), r.label = 2;
                        case 2:
                            if (n.error && n.liffOAuth2Error) throw a = n.error, s = n.error_description.replace(/\+/g, " "), c = "".concat(a, ": ").concat(s), Ce($, c);
                            return i = n.code, o = dt(), Boolean(i && !bt() && o && o.codeVerifier) ? [4, Jr(n.liffClientId)] : [3, 4];
                        case 3:
                            r.sent(), r.label = 4;
                        case 4:
        ...
        var Xr = function (e, t) {
            ...
            Qr = function (e) {
                ...
                return t && e && (t = t.replace(/\d{1,2}\.\d{1,2}\.\d{1,3}/, e)), Xr(t, "LUI_ALERT_URL is not defined")
            },
            Yr = function () {
                return k(void 0, void 0, void 0, (function () {
                    var e;
                        ...
                        switch (t.label) {
                            ...
                            case 3:
                                return t.sent(), [4, (n = xe(6), new Promise((function () {
                                    ...
                                    e.innerHTML = '<lui-alert id="'.concat("liffAlert", "-").concat(n, '" shown title="').concat(Sr("alert.android.extBrowser.autoLoginWorkaround.title"), '" message="').concat(Sr("alert.android.extBrowser.autoLoginWorkaround.desc"), '" button="').concat(Sr("alert.android.extBrowser.autoLoginWorkaround.button.text"), '"></lui-alert>'), document.body.appendChild(e);
                ...
                return k(this, void 0, void 0, (function () {
                    ...
                    return A(this, (function (i) {
                        switch (i.label) {
                            ...
                            case 2:
                                return i.trys.push([2, 9, , 11]), [4, Promise.all([Ar(this.liffForWindow), $r(e, this.internalHooks.beforeFinished.call)])];
                            case 3:
                                return i.sent(),
                                    function () {
                                        var e;
                            ...
                            case 4:
                                return i.sent(), !e.withLoginOnExternalBrowser || bt() ? [3, 6] : (mr(), [4, new Promise((function () {}))]);
                            case 5:
                                i.sent(), i.label = 6;
                            case 6:
                                return [4, ei()];
        ...
        function ii() {
            var e = Et();
            if (!e || !Je() || "ios" !== Ot()) return navigator.language;
            if (ve(e, "14.11.0") >= 0) {
            ...
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (c) {
                    switch (c.label) {
                        case 0:
                            return function (e) {
                                if (!de.includes(e)) throw Ce(z, "Unexpected permission name.");
                                var t = Xe();
        ...
        function si() {
            var e = qe().liffId;
            if (e) return Kt("".concat($t("unauthorizedPermissions"), "?liffId=").concat(e), {
                headers: {
                    "Content-Type": "application/json",
                    Accept: "application/json",
        ...
        var ci, ui = fr.on,
            ...
            di = function () {
                        ...
                        return k(n, [e], void 0, (function (e) {
                            ...
                            return A(this, (function (e) {
                                return t ? this.resolve({
                                    newAccessToken: t
                                }) : n && this.reject(Ce(J, n)), this.teardown(), [2]
                            }))
                        }))
                ...
                return e.prototype.setup = function () {
                    ui("submit", this.onSubmit), ui("close", this.onClose), ui("cancel", this.onCancel), ui("error", this.onError)
                }, e.prototype.teardown = function () {
                    li("submit", this.onSubmit), li("close", this.onClose), li("cancel", this.onCancel), li("error", this.onError), ci = void 0
        ...
        function hi() {
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            if (!ai()) throw Ce(X, "SkipChannelVerificationScreen is unavailable.");
                            return ci && ci.teardown(), e = function () {
                                return k(t, void 0, void 0, (function () {
                                    var e;
                                    return A(this, (function (t) {
                                        switch (t.label) {
        ...
        function pi() {
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (n) {
                    switch (n.label) {
                        case 0:
                            if (!(e = ut())) throw Ce(q, "Need access_token for api call, Please login first");
                            return [4, Xt(e)];
                        case 1:
                            return t = n.sent(), [2, decodeURIComponent(t.scope).split(" ").filter((function (e) {
                                return "" !== e
                            }))]
                    }
                }))
            ...
            return function () {
                ...
                return k(n, void 0, void 0, (function () {
                    ...
                    return A(this, (function (a) {
                        switch (a.label) {
                            case 0:
                                return n = (r.length > 0 ? r[r.length - 1] : {}).ignorePermissionCheck, i = void 0 !== n && n, [4, oi(t)];
                            case 1:
        ...
        function bi(e) {
            if (! function (e) {
                ...
                }(e)) throw Ce(z, "Invalid parameters for liff.openWindow()");
            var t = Et();
            if (Je())
        ...
        function Ii(e) {
            if (! function (e) {
                ...
                }(e)) return yi("Parameter 'messages' must be an array of { type, ... }");
            var t = e.length;
        ...
        var Oi, Pi = function (e) {
                ...
                return P(t, e), Object.defineProperty(t, "CUSTOMPLACEID_INIT", {
                    get: function () {
                        return "liff.init"
                    },
                    enumerable: !1,
            ...
            ki = /([\x90\x9D\x81\x8D\x8F<"{|}>\\^`â€œâ€ºâ€žâ€¢â€šÅ½Å â€¦â€™â€”Å¾â€“â€˜â€â€¡â„¢â€°Å’Å¡Å¸â€¹Å“â€ Â¥Â¿Â©Ã¡Ã„Ã½ÃÃŽÃ°Ã´]|\n|.*#.*#|%(?![0-9A-Fa-f]{2})[^%]{0,2})/,
            Ai = function (e) {
                if (ki.test(e)) throw Ce(z, "invalid URL.");
                var t = new URL(e),
                    n = t.username,
                    r = t.password,
                    i = t.hash,
            ...
            Ri = function (e, t) {
                var n = Ai(e),
                    r = new URL(t);
                if (n.username !== r.username || n.password !== r.password) throw Ce(z, "invalid URL.");
                if (r.origin !== n.origin || !Ui(r.pathname, n.pathname)) throw Ce(z, "invalid URL.")
            },
            Di = function (e) {
                function t() {
                    var t = e.apply(this, F([], x(arguments), !1)) || this;
                    return t.extraParams = "", t.getAndValidateContext = function () {
                        ...
                        if (s.origin !== a || !Ui(s.pathname, r)) throw Ce(Q, "Current page is not under entrypoint.");
                        ...
                        return k(t, void 0, void 0, (function () {
                            var t, n, r, i, o, a;
                            return A(this, (function (s) {
                                if (!(t = qe().liffId)) throw Ce($, "Should run after liff init.");
                                return n = this.getAndValidateContext(), Ri(e, n.endpointUrl), r = Ai(e), i = new URL(n.endpointUrl), o = n.miniDomainAllowed ? ie : re, a = n.miniDomainAllowed && n.miniAppId ? n.miniAppId : t, [2, o.concat(a, xi(r.pathname, i.pathname), ji(r.search, i.search), Ni(r.hash))]
                            }))
                        }))
            ...
            Mi = function () {
                ...
                return e.prototype.start = function () {
                    fr.on("submit", this.onSubmit), fr.on("close", this.onClose), fr.on("cancel", this.onCancel), fr.on("error", this.onError)
                }, e.prototype.destroy = function () {
                    fr.off("submit", this.onSubmit), fr.off("close", this.onClose), fr.off("cancel", this.onCancel), fr.off("error", this.onError), Oi = void 0
                }, e
            }();
        ...
        function Wi() {
            return k(this, void 0, void 0, (function () {
                return A(this, (function (e) {
                    return Ft.scanCodeV2(), Oi && Oi.destroy(), [2, new Promise((function (e, t) {
                        Oi = new Mi(e, t), fr.open({
                            url: "https://liff.line.me/1656359117-jxmx5e11"
                        }).catch((function (e) {
                            null == Oi || Oi.destroy(), t(e)
                        }))
                    }))]
                }))
            }))
        ...
        function qi(e, t, n, r) {
            if (void 0 === n && (n = {}), "object" != typeof e || !e.postMessage) throw Ce(z, "target must be window object");
            if ("string" != typeof t) throw Ce(z, "keyname must be string");
            if ("object" != typeof n) throw Ce(z, "incorrect body format. It should be Object or Array comprised of Object");
            if (!r) throw Ce(z, "serverEndPointUrl isn't passed. please fill up with proper url");
        ...
        function zi(e, t, n, r) {
            ! function (e, t, n, r) {
                ...
                new Promise((function (o) {
                    ...
                    ! function (e, t) {
                        Vi[e] = t
                    }(t, a), e.addEventListener(i, a, !!Ji && r)
                }))
        ...
        var $i = function () {
                ...
                return e.getInstance = function () {
                    ...
                    var e, t;
                    this.abortController && this.abortController.abort(), Je() || (e = this.timeoutIDForHealthCheck, t = this.popupWindow, Gi(window, "message.receivedHealthcheck"), e && clearTimeout(e), t && !t.closed && t.close())
                    ...
                    return k(this, void 0, void 0, (function () {
                        ...
                        return A(this, (function (r) {
                            switch (r.label) {
                                case 0:
                                    return this.abortController && (e = this.abortController.signal), t = "".concat($t("shareTargetPickerOtt"), "/").concat(this.liffId, "/ott"), n = this, [4, Kt(t, {
                                        method: "GET",
                                        signal: e
                                    }).then((function (e) {
                                        return e.ott
                    ...
                    var e, t;
                    Je() || (e = this.onReceivedHealthcheck.bind(this), t = this.allowPostMessageOrigin, zi(window, "receivedHealthcheck", e, t))
                        ...
                        return A(this, (function (t) {
                            switch (t.label) {
                                ...
                                case 6:
                                    return [3, 8];
                                case 7:
                                    qi(this.popupWindow, "healthcheck", void 0, this.allowPostMessageOrigin), this.timeoutIDForHealthCheck = window.setTimeout(this.healthCheck.bind(this), 1e3), t.label = 8;
                                case 8:
                                    return [2]
                            }
                        }))
                    ...
                    return k(this, void 0, void 0, (function () {
                        ...
                        return A(this, (function (n) {
                            ...
                            return this.abortController && (e = this.abortController.signal), t = {
                                liffId: this.liffId,
                                ott: this.ott
                            }, R.debug("fetch: getShareResult"), [2, Kt("".concat($t("shareTargetPickerResult"), "?").concat(Ae(t)), {
                                method: "GET",
                                headers: {
                                    Accept: "application/json"
                                },
                ...
                function t() {
                    ...
                    return t.shareTargetPicker = function (e) {
                        ...
                        return k(t, F([e], x(n), !1), void 0, (function (e, t) {
                            var n, r, i, o, a, s, c;
                            return void 0 === t && (t = {}), A(this, (function (u) {
                                switch (u.label) {
                                    case 0:
                                        if (Ft.shareTargetPicker(), !e || !Array.isArray(e) || 0 === e.length) throw Ce(z, "no proper argument");
                                        if (e.length > 5) throw Ce(z, "exceed the limit of num of messages");
                                        if (!(n = qe().liffId)) throw Ce(Q);
                                        window.liff && (r = window.liff).analytics && _i(r.analytics), i = void 0 === t.isMultiple || t.isMultiple, u.label = 1;
                                    case 1:
                                        return u.trys.push([1, 3, , 4]), o = $i.getInstance(), a = Et(), s = {
        ...
        function Yi(e, t) {
            return k(this, void 0, void 0, (function () {
                ...
                return A(this, (function (i) {
                    switch (i.label) {
                        case 0:
                            return n = $t("createShortcutOnHomeScreen"), (r = new URL(n)).searchParams.append("liffId", e), r.searchParams.append("url", t.url), t.description && r.searchParams.append("description", t.description), [4, Kt(r.toString())];
                        case 1:
        ...
        function Zi(e) {
            if (Me(e)) throw Ce(z, "LINE URL scheme are not supported in the current environment.")
        }
            ...
            return k(this, void 0, void 0, (function () {
                return A(this, (function (n) {
                    switch (n.label) {
                        ...
                        case 1:
                            return n.sent(), "hidden" === document.visibilityState ? [2] : (Zi(t.url), [4, Yi(e, t)]);
                        case 2:
                            return bi({
                                url: n.sent(),
                                external: !0
                ...
                return A(this, (function (i) {
                    switch (i.label) {
                        case 0:
                            ...
                            }, r = "".concat("line://shortcut/liff", "?").concat(Ae(n)), location.href = r, [4, eo(e, t)];
                        case 1:
                            return i.sent(), [2]
                    }
                }))
        ...
        function ro(e) {
            var t;
            if (void 0 === e.url || null === e.url || "" === e.url) throw Ce(z, "no proper argument");
            var n = Xe();
                        ...
                        return function (e) {
                            return k(this, void 0, void 0, (function () {
                                return A(this, (function (t) {
                                    switch (t.label) {
                                        case 0:
                                            return ro(e), Ft.createShortcutOnHomeScreen(), [4, io(e)];
                                        case 1:
                                            return t.sent(), [2]
                                    }
                                }))
                        ...
                        return function (e) {
                            return k(this, void 0, void 0, (function () {
                                return A(this, (function (t) {
                                    switch (t.label) {
                                        case 0:
                                            return ro(e), Ft.internalCreateShortcutOnHomeScreen(), [4, io(e)];
                                        case 1:
                                            return t.sent(), [2]
                                    }
                                }))
                    ...
                    switch (e.label) {
                        case 0:
                            return [4, wn("iap.getPlatformProducts", {
                                ...
                                if (e.code && e.description) throw Ce(e.code, e.description);
                ...
                return P(t, e), Object.defineProperty(t.prototype, "name", {
                    ...
                    return {
                        ...
                        requestConsentAgreement: function () {
                            return k(e, void 0, void 0, (function () {
                                return A(this, (function (e) {
                                    return Ft.iap(), [2, k(void 0, void 0, void 0, (function () {
                                        return A(this, (function (e) {
                                            switch (e.label) {
                                                case 0:
